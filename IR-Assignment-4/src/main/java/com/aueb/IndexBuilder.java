...
public class IndexBuilder {
    ...
    public IndexBuilder(String filePath, Similarity similarity) throws IOException {
        path = filePath;
    ...
    public ArrayList<Utils.QueriedDoc[]> getDocsForQueries(String queriesPath, int k, Similarity similarity)
