...
//    public static INDArray toDenseAverageVector(Terms docTerms, double n, Word2Vec word2Vec, WordEmbeddingsSimilarity.Smoothing smoothing, boolean p) throws IOException {
//        INDArray documentVector = Nd4j.zeros(word2Vec.getLayerSize());
//        ArrayList<String> docTermList = new ArrayList<>(); // TODO REMOVE
//        int termsCounted = 0; // TODO REMOVE
//        if (docTerms != null) {
//            TermsEnum docTermsEnum = docTerms.iterator();
//            BytesRef term;
//            while ((term = docTermsEnum.next()) != null) {
//                docTermList.add(term.utf8ToString()); // TODO REMOVE
//                INDArray wordVector = word2Vec.getLookupTable().vector(term.utf8ToString());
//                if (p) {System.out.println(term.utf8ToString() + " : " + wordVector);}
//                if (wordVector != null) {
//                    termsCounted++; // TODO REMOVE
//                    smoothDocVector(docTerms, n, smoothing, documentVector, docTermsEnum, wordVector);
//                }
//            }
//        }
//        if (p) {System.out.println("TERMS EXISTING: " + docTermList.size() + " TERMS VECTORIZED FOR REPRESNTATION "  + termsCounted);} // TODO REMOVE
//        return documentVector;
//    }    public static INDArray toDenseAverageVector(Terms docTerms, double n, Word2Vec word2Vec, WordEmbeddingsSimilarity.Smoothing smoothing, boolean p) throws IOException {
//        INDArray documentVector = Nd4j.zeros(word2Vec.getLayerSize());
//        ArrayList<String> docTermList = new ArrayList<>(); // TODO REMOVE
...
//    public static INDArray toDenseAverageVector(String body, double n, Word2Vec word2Vec, WordEmbeddingsSimilarity.Smoothing smoothing) throws IOException {
//        INDArray documentVector = Nd4j.zeros(word2Vec.getLayerSize());
//        int termsCounted = 0;
//        String[] terms = body.split(" ");
//        if (terms.length > 0) {
//            for (String term : terms) {
//                INDArray wordVector = word2Vec.getLookupTable().vector(term);
//                if (wordVector != null) {
//                    termsCounted++;
...
//            }
//        }
//        documentVector.divi(termsCounted);
//        return documentVector;
//    }
    ...
    private static void smoothDocVector(Terms docTerms, double n, WordEmbeddingsSimilarity.Smoothing smoothing,
        ...
        switch (smoothing) {
            case MEAN:
                smooth = docTerms.size(); // KANEI FALSE ASSUMPTION OTI 8A BREI GIA OLA TA TERMS EMBEDDING! EPREPE NA METRHSEI POSA EXOYN REPR KAI META NA DIAIRESEI DIA AYTO TO PLI8OS
                break;
            case TF:
