...
public class IndexBuilder {
    ...
    public IndexBuilder(String filePath, float lambda, float b, float k1) throws IOException {
        path = filePath;
    ...
    public ArrayList<Utils.QueriedDoc[]> getDocsForQueries(String queriesPath, int k, float lambda, float b, float k1)
